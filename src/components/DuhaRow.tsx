...
export default function DuhaRow(props: { dateDuha: Date; dateSyuruk?: Date }) {
  return (
    <div class="bg-white px-3 pb-5 flex flex-row text-[2.7vh] items-center justify-between">
      {/* Left column: Duha */}
      <div class="flex flex-col items-center justify-start leading-[1.3]">
        <div
          class="font-black text-xl font-[Cairo] text-green-800 text-left"
          dir="rtl"
        >
          يبدأ الضحى الساعة
        </div>
      ...
      <div class="flex flex-col items-center justify-end leading-[1.3]">
        ...
        <div class="text-xl font-medium text-right text-[#c0392b]">
          {props.dateSyuruk
